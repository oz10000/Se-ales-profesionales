...
class Scanner:
    ...
    def scan_all(self) -> List[Dict]:
        ...
        for asset in assets:
            try:
                ...
                time_to_entry = self._estimate_time_to_entry(signal['entry'], indicators)
    ...
    def _estimate_time_to_entry(self, entry: float, indicators: dict) -> str:
        current_price = indicators.get('current_price', 0)
        atr = indicators.get('atr', 0.01)
